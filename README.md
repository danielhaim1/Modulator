...
If you prefer to use Modulator directly in your browser without installing the package, you can import it via a CDN like esm.sh. Simply add the following line to your HTML file or JavaScript module to start using it:
